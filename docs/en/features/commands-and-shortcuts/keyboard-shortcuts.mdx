...
| `clineChinese.SidebarProvider.focus`                                                     | Opens and focuses the Cline sidebar           |
...
| --------------------- | ------------------------------ | ----------------------------------------- | ----------------------------- |
| Open Cline Sidebar    | `Ctrl+Shift+C` / `Cmd+Shift+C` | `clineChinese.SidebarProvider.focus`      | Opens the Cline sidebar panel |
