...
export async function createShengsuanyunStream(
	client: OpenAI,
	systemPrompt: string,
	...
	if (
		...
		model.id.startsWith("deepseek/deepseek-v3") ||
		model.id.startsWith("deepseek/deepseek-chat") ||
		model.id.startsWith("deepseek/deepseek-reason") ||
