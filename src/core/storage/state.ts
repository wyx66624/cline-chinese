...
export async function getAllExtensionState(context: vscode.ExtensionContext) {
	...
	const [
		...
		getGlobalState(context, "planModeShengSuanYunModelId") as Promise<string | undefined>,
		getGlobalState(context, "planModeShengSuanYunModelInfo") as Promise<ShengSuanYunModelInfo | undefined>,
		...
		getGlobalState(context, "actModeShengSuanYunModelId") as Promise<string | undefined>,
		getGlobalState(context, "actModeShengSuanYunModelInfo") as Promise<ShengSuanYunModelInfo | undefined>,
